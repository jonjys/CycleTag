...
export default function AffiliatePage() {
  return <main className="legal-page"><article><div className="section-kicker">TRANSPARENT MONETIZATION</div><h1>Affiliate disclosure</h1><p className="updated">Last updated 4 September 2026</p>
    <p>Some marketplace links can be affiliate links. If you click one and complete a qualifying purchase, StayTag may receive a commission from the marketplace. You pay the same price.</p>
    ...
    <p>An affiliate relationship does not determine the search phrase stored in your tag. StayTag does not display marketplace prices, reviews or seller claims and does not automatically place orders.</p>
    ...
    <p>If a qualifying purchase earns a commission, it is received by <a href={contactLinks.operator}>{contact.operatorName}</a> in {contact.country}. {operatorTaxDisclosure}</p>
    <p>For general questions about StayTag or its affiliate relationships, email <a href={contactLinks.general}>{contact.email.general}</a>.</p>
  </article></main>;
}
