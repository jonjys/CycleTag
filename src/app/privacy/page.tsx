...
export default function PrivacyPage() {
  return <Legal title="Privacy policy" updated="15 September 2026">
    ...
    <h2>What CycleTag stores</h2><p>CycleTag does not provide accounts and does not store the content of tags in a database. Item names, optional part numbers, replacement dates, intervals, care history, optional photo hashes and marketplace settings are encoded after the # in the URL and QR code. Browsers do not send that fragment to the web server. Anyone with the QR or link can read these fields.</p>
    <h2>Optional photos</h2><p>Photo hashing runs locally in your browser using SHA-256. CycleTag never uploads or stores the photo. Only its hash is included in the tag and optional local My tags shelf. Keep the original file yourself; a hash cannot reconstruct the photo or certify maintenance.</p>
